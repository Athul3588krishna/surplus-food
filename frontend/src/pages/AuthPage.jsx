...
import { KeyRound, Mail, User as UserIcon, Phone, Store, MapPin, UtensilsCrossed, FileText } from 'lucide-react';
...
const AuthPage = () => {
  ...
  return (
    <div className="auth-container animate-fade-in" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: 'calc(100vh - 70px)', padding: '2rem 1.5rem' }}>
      <div className="glass-panel" style={{ width: '100%', maxWidth: role === 'restaurant' && !isLogin ? '650px' : '450px', padding: '2.5rem', transition: 'max-width 0.3s ease' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: role === 'restaurant' && !isLogin ? '1fr 1fr' : '1fr', gap: '1.5rem' }}>
            ...
            {/* Right Column / Restaurant Details (Only visible when role === 'restaurant' and Registering) */}
